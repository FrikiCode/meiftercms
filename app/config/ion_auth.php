 ...
 */
$config['site_title']                 = getSiteConfiguration()['site_name'];       // Site Title, example.com
$config['admin_email']                = getSiteConfiguration()['site_mail']; // Admin Email, admin@example.com
...
$config['email_config'] = array(
	'mailtype' => 'html',
	'protocol' => 'smtp',
	'smtp_host' => getMailConfiguration()['smtp_host'],
	'smtp_port' => getMailConfiguration()['smtp_port'],
	'smtp_user' => getMailConfiguration()['smtp_user'],
	'smtp_pass' => getMailConfiguration()['smtp_pass'],
	'charset' => getMailConfiguration()['smtp_charset'],
	'wordwrap' => TRUE
);
