...
class Crud extends CI_Controller {
	...
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'internal_pages';
			$data['title'] = 'Paginas Internas';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de paginas internas.';
	...
	public function TestimonialView()
	{
		if ($this->ion_auth->logged_in()) {
			...
			$data['title'] = 'Testimoniales';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Testimonios de Clientes.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function AboutView()
	{
		if ($this->ion_auth->logged_in()) {
			...
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Bloques de Contenido para la seccion "Sobre Nosotros".';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function Product()
	{
		if ($this->ion_auth->logged_in()) {
			...
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Productos.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function ProdCat()
	{
		if ($this->ion_auth->logged_in()) {
			...
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Categoria de Productos.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function Tax()
	{
		if ($this->ion_auth->logged_in()) {
			...
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Impuestos.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function SegmentView()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'segment';
			$data['title'] = 'Segmentos';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Segmentos.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function BrandView()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'brand';
			$data['title'] = 'Marcas';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Marcas.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function FrequentQuestions()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'faq';
			$data['title'] = 'F.A.Q.';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Preguntas Frecuentes.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function PostView()
	{
		if ($this->ion_auth->logged_in()) {
			...
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Articulos.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function PostCatView()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'postcat';
			$data['title'] = 'Categoria de Articulos';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Categoria de Articulos.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function MailConfView()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'mailconf';
			$data['title'] = 'Configuracion de E-Mail';
			$data['desc'] = 'Parametros para la Configuracion de E-Mail';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function currencyview()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'Currency';
			$data['title'] = 'Divisas';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Divisas.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function methodpayview()
	{
		if ($this->ion_auth->logged_in()) {
			...
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Metodos de Pago.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function StoreConfView()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'storeconf';
			$data['title'] = 'Configuracion de Tienda';
			$data['desc'] = 'Parametros para la configuracion de la tienda.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function PromoCodeView()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'promocode';
			$data['title'] = 'Codigos Promocionales';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Codigos Promocionales.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'saleregistry';
			$data['title'] = 'Registro de Ventas';
			$data['desc'] = 'Visualizacion de las Ventas Realizadas.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'shippingCost';
			$data['title'] = 'Costos de Envio';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Costos de Envio.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function PaisView()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'pais';
			$data['title'] = 'Paises';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Paises.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
	...
	public function combosview()
	{
		if ($this->ion_auth->logged_in()) {
			$data['url'] = 'combos';
			$data['title'] = 'Combos';
			$data['desc'] = 'Seccion de creacion, modificacion y eliminacion de Combos.';
			$this->load->view('v2/pages/crud-holder', $data);
		}else{
			redirect('/auth/login');
		}
